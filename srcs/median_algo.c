...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/11/21 11:19:32 by jleblond          #+#    #+#             */
/*   Updated: 2019/11/21 11:19:34 by jleblond         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "push_swap.h"

// void	maybe_better_b(t_stack *stk, char flags, FILE *fp)
// {
// 	if (stk->b_len < 2)
// 		return ;
// 	else if (stk->b_len == 2)
